...
export const metadata = {
  title: 'Music Marketing Companies — Cast & Promote Fast | Influence Models Agency',
  description: 'Book verified talent for your music video and get creators to promote your song on TikTok & Instagram.',
};

export default function LandingPage_music_marketing_companies() {
  return (
    <main className="min-h-screen bg-black text-white font-sans">
      ...
      <section className="relative px-6 pt-20 pb-16 text-center max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl md:text-6xl font-black leading-tight mb-6">
          Music Marketing Companies — Cast & Promote Fast
        </h1>
