...
export const metadata: Metadata = {
  title: 'Influencer Marketing Agency Boca Raton — Story Reposts, Collab Posts, UGC & Models | Influence',
  description: 'Boca Raton influencer marketing agency. Book celebrity-connected creators for story reposts, collab posts, UGC content, business promotion, events, and music videos. Serving Palm Beach County.',
  alternates: {
    canonical: 'https://influencemodels.agency/influencer-marketing-boca-raton',
  },
  openGraph: {
    locale: 'en_US',
    siteName: 'Influence Models Agency',
    title: 'Influencer Marketing Agency Boca Raton — Story Reposts, Collab Posts & UGC',
    description: 'Boca Raton\'s premier influencer marketing agency. Celebrity-connected talent, story reposts, collab posts, UGC, transparent pricing for brands and businesses.',
    url: 'https://influencemodels.agency/influencer-marketing-boca-raton',
    type: 'website',
  },
  twitter: {
...
const localBusinessSchema = {
  ...
  description: 'Boca Raton influencer marketing agency. Book celebrity-connected influencers for story reposts, collab posts, UGC content, business promotion, events, and model bookings.',
  url: 'https://influencemodels.agency/influencer-marketing-boca-raton',
  telephone: '+15615520392',
  email: 'influencemodelsagency@gmail.com',
  address: {
    '@type': 'PostalAddress',
    streetAddress: 'Serving Palm Beach County',
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'How much does influencer marketing cost in Boca Raton?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Boca Raton influencer marketing starts at $300 for UGC content. Event models start at $400/girl. Music video models start at $500. Pricing varies based on the influencer\'s following, content type, and campaign scope.',
      },
    },
    {
      '@type': 'Question',
      name: 'Do you work with Boca Raton-based influencers only?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'We work with both Boca Raton-based influencers and nationwide talent. For on-site bookings in Palm Beach County, we prioritize local influencers. For remote UGC content, we can work with influencers anywhere in the US.',
      },
    },
    {
      '@type': 'Question',
      name: 'How fast can you book Boca Raton influencers?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'We offer same-day response for Boca Raton bookings. Most campaigns can be booked and scheduled within 24-48 hours. Remote UGC content is typically delivered within 3-7 days.',
      },
    },
    {
      '@type': 'Question',
      name: 'What areas of Palm Beach County do you serve?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'We serve all of Palm Beach County including Boca Raton, Delray Beach, Boynton Beach, Deerfield Beach, West Palm Beach, Palm Beach, and surrounding areas.',
      },
    },
  ],
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      '@type': 'ListItem',
      position: 2,
      name: 'Boca Raton Influencer Marketing',
      item: 'https://influencemodels.agency/influencer-marketing-boca-raton',
    },
  ],
};
      ...
      <div className="min-h-screen bg-[#080808]">
        ...
        <section className="relative min-h-[85vh] flex items-end overflow-hidden pt-20">
          ...
          <div className="relative z-10 px-8 md:px-16 pb-16 md:pb-24 max-w-4xl">
            <p className="text-[10px] font-bold tracking-[0.4em] uppercase mb-6" style={{ color: gold }}>Boca Raton Influencer Marketing</p>
            <h1 className="font-display font-bold italic text-white leading-[0.9] mb-6" style={{ fontSize: 'clamp(40px, 7vw, 96px)' }}>
              Boca Raton<br />Influencer Agency
            </h1>
            <p className="text-white/60 text-lg md:text-xl max-w-xl leading-relaxed mb-10">
              Verified models and influencers for UGC content, business promotion, events, and music videos. Serving Boca Raton, Delray Beach, Palm Beach Gardens, and Palm Beach County.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="/model-booking" className="inline-flex items-center justify-center gap-3 px-10 py-5 text-[13px] font-bold tracking-widest uppercase hover:opacity-85 transition-all" style={{ backgroundColor: gold, color: '#000' }}>
                Book Boca Raton Influencers <ChevronRight className="h-4 w-4" />
              </Link>
        ...
        <section className="py-20 md:py-28 px-8 md:px-16 border-t border-white/[0.06]">
          <div className="max-w-4xl">
            <p className="text-[10px] font-bold tracking-[0.4em] uppercase mb-6" style={{ color: gold }}>Palm Beach County</p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl">
              {[
                ...
                'Palm Beach Gardens', 'Wellington', 'Jupiter', 'North Palm Beach',
                'Lake Worth', 'Greenacres', 'Royal Palm Beach', 'Lantana'
              ].map(city => (
        ...
        <section className="py-20 md:py-28 px-8 md:px-16 bg-[#060606] border-t border-white/[0.06]">
          <div className="max-w-5xl">
            ...
            <h2 className="font-display font-bold italic text-white leading-[0.9] mb-14" style={{ fontSize: 'clamp(32px, 4vw, 56px)' }}>
              Influencer marketing<br />for Boca Raton brands.
            </h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
              {[
                { name: 'Business Content', price: 'From $300', desc: 'On-site content for Boca Raton restaurants and businesses.' },
                { name: 'UGC Content', price: 'From $300', desc: 'Remote content creation for Boca Raton brands.' },
                { name: 'Event Models', price: 'From $400/girl', desc: 'Professional models for Boca Raton events and parties.' },
                { name: 'Music Video Models', price: 'From $500', desc: 'Talent for Boca Raton music video productions.' },
                { name: 'Commercial Production', price: 'From $599', desc: 'Scripted commercials and speaking roles.' },
                { name: 'Music Promotion', price: 'From $300', desc: 'Song reaction videos for Boca Raton artists.' },
              ].map(({ name, price, desc }) => (
        ...
        <section className="py-20 md:py-28 px-8 md:px-16 border-t border-white/[0.06]">
          <div className="max-w-4xl">
            <p className="text-[10px] font-bold tracking-[0.4em} uppercase mb-6" style={{ color: gold }}>Why Boca Raton</p>
            <h2 className="font-display font-bold italic text-white leading-[0.9] mb-14" style={{ fontSize: 'clamp(32px, 5vw, 64px)' }}>
              Local expertise for<br />Palm Beach County brands.
            </h2>
            <div className="space-y-6">
              {[
                { title: 'Palm Beach County Knowledge', desc: 'We know Boca Raton and Palm Beach County. From Mizner Park to Delray Beach, we understand the local market.' },
                { title: 'Verified Local Talent', desc: 'Our roster includes models and influencers based in Boca Raton with authentic local followings.' },
                { title: 'Business Content Expertise', desc: 'Experience with Boca Raton restaurants, salons, boutiques, and businesses for on-site content creation.' },
                { title: 'Fast Local Response', desc: 'Same-day response for Boca Raton bookings. Our team is ready to mobilize across Palm Beach County.' },
              ].map(({ title, desc }) => (
        ...
        <section className="py-20 md:py-32 px-8 md:px-16 bg-white border-t border-black/10">
          <div className="max-w-3xl">
            <p className="text-black/40 text-[10px] tracking-[0.5em} uppercase mb-8 font-semibold">Boca Raton Brands</p>
            <h2 className="font-display font-bold italic text-black leading-[0.9] mb-6" style={{ fontSize: 'clamp(40px, 7vw, 80px)' }}>
              Grow your brand<br />in Palm Beach County.
            </h2>
            <p className="text-black/50 text-lg mb-10 max-w-lg">Book Boca Raton influencers for your next campaign. From $300.</p>
            <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-16 pt-16 pb-10">
            <div className="flex flex-col md:flex-row justify-between gap-16 mb-16">
              <div>
                ...
                <p className="text-white/30 text-xs mb-1">Boca Raton, FL 33431</p>
